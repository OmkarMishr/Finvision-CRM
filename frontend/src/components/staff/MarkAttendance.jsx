        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl shadow border border-gray-100 p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-3">
              {[
                { icon: Clock,       color: 'text-blue-500',   bg: 'bg-blue-50',   text: 'Office hours: 9:00 AM – 6:00 PM'           },
                { icon: MapPin,      color: 'text-green-500',  bg: 'bg-green-50',  text: 'Must be within 200m of institute'           },
                { icon: AlertCircle, color: 'text-orange-500', bg: 'bg-orange-50', text: 'Check-in after 9:15 AM is marked Late'      },
