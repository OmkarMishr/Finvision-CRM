...
import { Search, Download, FileSpreadsheet, Bell, Users, CheckCircle, XCircle, Menu, Edit, Trash2 } from 'lucide-react'
            ...
            <div className="p-6 sm:p-8 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <button className="p-2.5 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-colors" title="Export to Excel">
                    <FileSpreadsheet className="w-5 h-5" />
                  </button>
                  <button className="p-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-colors" title="Download PDF">
                    ...
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button className="p-1.5 hover:bg-indigo-50 rounded-lg transition-colors" title="Edit">
