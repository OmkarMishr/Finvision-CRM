...
import { Calendar, FileText, CreditCard, BookOpen, Award, Bell, Menu, TrendingUp, DollarSign, Clock, Users, GraduationCap, CheckCircle, AlertCircle, MapPin, Download, User } from 'lucide-react'
...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    if (activeTab === 'certificate' && studentData?._id) {
            ...
            <div className="p-6 sm:p-8">
              ...
              {activeTab === 'certificate' && (
                <CertificateSection 
                  ...
                  onCheckEligibility={checkCertificateEligibility}
...
const CertificateSection = ({ studentData, eligibility, checkingEligibility, loadingCertificate, onCheckEligibility, onDownload }) => {
